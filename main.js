 ...
 */
var firebaseConfig = {
    apiKey: "AIzaSyAabCl3EiROPnUEyrxPFs0h354MafitUcs",
    authDomain: "yedpay.firebaseapp.com",
    databaseURL: "https://yedpay.firebaseio.com",
    projectId: "yedpay",
    storageBucket: "yedpay.appspot.com",
    messagingSenderId: "442576210778",
    appId: "1:442576210778:web:adc27983bab49db9074163",
    measurementId: "G-9YKEK9KXW7"
  };
  // Initialize Firebase
...
;~function(global) {
	 ...
	 */
	var MARGIN_TOP = 30;
	var STAGE_WIDTH = 360, STAGE_HEIGHT = 480 + MARGIN_TOP; //場境
	var FLOOR_WIDTH = 100, FLOOR_HEIGHT = 12, FLOOR_DISTANCE = 60; //地板
	...
	function drawAll(context, time) {
		...
		if (!isRunning) {
			...
			if (isCooldownTime) {
				...
				context.textAlign = 'center';
				context.fillText(judge() ? 'submit' : 'continue', 0, 10);
			}
			context.restore();
		}
		...
		if (topBarChange) {
			...
			context.fillText('生命值: ' + 'ooooooooooxxxxxxxxxx'.substr(10 - hero.life, 10) + '  分數: ' + score, 10, 24 );
			context.restore();
		}
				...
				if (!isRunning && !isCooldownTime) {
                  ...
                  var person = prompt("Please enter your name", "");
					if (person != null) {
                      ...
                      alert(person + ", you have submit " + bestScore + " score");
					  db.collection("games").add({name:person, score:bestScore }).then(function(docRef) {alert(docRef.id);})
					  }
